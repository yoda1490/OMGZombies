...
public class Field {
    ...
    /**
     * Place an character at the given location. If there is already an character at
     * the location it will be lost.
     * 
     * @param character
     *            The character to be placed.
     * @param row
     *            Row coordinate of the location.
     * @param col
     *            Column coordinate of the location.
     */
    public void place(Object character, int row, int col) {
        place(character, new Location(row, col));
    }
